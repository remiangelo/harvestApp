...
export default function GardenerScreen() {
  ...
  const [activeTab, setActiveTab] = useState<'tips' | 'values'>('tips');
        ...
        <SafeAreaView>
          <View style={styles.header}>
            <View style={styles.headerContent}>
              <Text style={styles.headerTitle}>Tips & Values</Text>
              <Text style={styles.headerSubtitle}>Dating Advice & Self-Discovery</Text>
            </View>
          </View>
          ...
          {/* Category Filters - Only show for Tips tab */}
          {activeTab === 'tips' && (
            <ScrollView
              horizontal
        ...
        >
          ...
          >
            ...
            <TouchableOpacity
              ...
              onPress={async () =>
                setReflection(await getDailyReflection(new Date(Date.now() + 1)))
              }
            >
