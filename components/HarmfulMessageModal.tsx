...
interface HarmfulMessageModalProps {
  visible: boolean;
  onClose: () => void;
  onViewAnyway: () => void;
  reason: string;
...
export const HarmfulMessageModal: React.FC<HarmfulMessageModalProps> = ({
  visible,
  onClose,
  onViewAnyway,
  reason,
      ...
      <BlurView intensity={80} tint="dark" style={styles.backdrop}>
        ...
        <View style={styles.modalContainer}>
          ...
          >
            ...
            {/* Title */}
            <Text style={styles.title}>This message may contain harmful content</Text>
            ...
            <View style={styles.lessonContainer}>
              <View style={styles.lessonHeader}>
                ...
                <Text style={styles.lessonTitle}>Safety Reminder</Text>
              </View>
            ...
            <View style={styles.buttonContainer}>
              {/* View Anyway Button (Secondary) */}
              <TouchableOpacity
                style={[styles.button, styles.secondaryButton]}
                onPress={onViewAnyway}
                activeOpacity={0.7}
              >
                <Text style={styles.secondaryButtonText}>View Anyway</Text>
              </TouchableOpacity>

              {/* Block/Report Button (Primary) */}
              <TouchableOpacity
              ...
              >
                ...
                <Text style={styles.primaryButtonText}>Keep Hidden</Text>
              </TouchableOpacity>
            </View>

            {/* Settings Note */}
            <Text style={styles.settingsNote}>
              You can report this user or adjust your safety settings
            </Text>
          </LiquidGlassView>
        </View>
      </BlurView>
