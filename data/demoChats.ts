...
export const demoChats: DemoChat[] = [
  {
    ...
    lastMessage:
      'I just finished a short film about urban beekeeping! Want to grab coffee and I can show you some clips?',
  ...
  },
  {
    ...
    lastMessage:
      "There's this amazing independent bookstore in the Mission that has a great sci-fi section. We should check it out!",
  ...
  },
  {
    ...
    lastMessage:
      "I'm planning a research trip to Iceland next summer. Want to hear about it over dinner? 🌋",
  ...
  },
  {
    ...
    lastMessage:
      "That's so exciting! I'd love to come support. I'm always looking for new artists to follow",
